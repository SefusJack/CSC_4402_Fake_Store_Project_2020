...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <div style="position:relative; background: #FFFFFF;border: 1px solid #BBBBBB;border-radius: 4px; width:260px; height:480px; margin:20px">
            ...
            <form style="width: 20px;position: absolute;height: 24px;left: 20px;right: 12px;/* top: calc(50% - 24px/2); */bottom: 83px;font-family: Inter;font-style: normal;font-weight: 500;font-size: 14px;color: #2264D1; onsubmit="return addToCart(2, this)" method="post">
