...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo("<div><div style='border:1px solid #BBBBBB;border-radius: 4px; margin:5px; display:grid;align-items: stretch;justify-items: stretch;grid-template-columns: repeat(5,1fr);'>");
